...
globalAmbienceIntensity = 0.60; // Set general ambience
globalAmbienceColor = "white"; // General ambience color
...
function startScene() {
    ...
    // Grass
    grassTexture = THREE.ImageUtils.loadTexture("https://images.unsplash.com/photo-1612722536930-177bac259038?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80");
    ...
    // Forest
    forestFrontTexture = THREE.ImageUtils.loadTexture("https://images.unsplash.com/photo-1548266652-99cf27701ced?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80");
    forestFrontTexture.wrapS = forestFrontTexture.wrapT = THREE.RepeatWrapping; // Allow texture wrapping
    forestFrontTexture.repeat.set(0, 1); // Repeat the grid texture
    ...
    var crateOneGeo = new THREE.BoxGeometry(2, 2, 2,2, 2,2);
...
crateInfoArray = [{
    name: "Lorem, ipsum. 1", // First crate
    text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis nam quod qui tenetur iure, cum modi odit. Voluptatibus, molestiae reprehenderit?",
    price: "20,000"
}, {
    name: "Lorem, ipsum. 2", // Second crate
    text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis nam quod qui tenetur iure, cum modi odit. Voluptatibus, molestiae reprehenderit?",
    price: "49,999"
}, {
    name: "Lorem, ipsum. 3", // Third crate
    text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis nam quod qui tenetur iure, cum modi odit. Voluptatibus, molestiae reprehenderit?",
    price: "119,999"
}, {
    name: "Lorem, ipsum. 4", // Fourth crate
    text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis nam quod qui tenetur iure, cum modi odit. Voluptatibus, molestiae reprehenderit?",
    price: "999,999"
}]
